...
class ChurchesControllerTest < ActionController::TestCase
  ...
  test "should create church" do
    assert_difference('Church.count') do
      post :create, church: { address: @church.address, ip: @church.ip, name: @church.name, sunday_mass: @church.sunday_mass, telephone: @church.telephone }
    end
  ...
  test "should update church" do
    patch :update, id: @church, church: { address: @church.address, ip: @church.ip, name: @church.name, sunday_mass: @church.sunday_mass, telephone: @church.telephone }
    assert_redirected_to church_path(assigns(:church))
  end
